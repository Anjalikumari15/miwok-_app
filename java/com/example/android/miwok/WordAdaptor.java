...
/**
 * Created by ANJALI KUMARI on 02-10-2018.
 */
...
public class WordAdaptor extends ArrayAdapter<Word> {
 ...
 //   private int mAudioId;
    ...
    public WordAdaptor(Activity context, ArrayList<Word> words, int colorId) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        miwokTextView.setText(currentWord.getMivokTranslation());
